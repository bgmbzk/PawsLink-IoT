...
* **RF Performansı (Anten Keep-out):** ESP32'nin üzerindeki PCB antenin verimli çalışması için, antenin altında kalan tüm katmanlarda bakır dökümü iptal edildi (No-copper zone). Bu sayede kablosuz bağlantı stabilitesi maksimuma çıkarıldı.
